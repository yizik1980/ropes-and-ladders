const T = {
  he: {
    ...
    'roll.wait':   (n) => `⏳ תור: ${n}`,
    'solo.score':     (s) => `ניקוד סופי: ${s} נקודות`,
    'solo.highscore': (s) => `שיא אישי: ${s} נקודות`,
    'solo.newrecord': '🏅 שיא אישי חדש!',
  ...
  en: {
    ...
    'solo.score':     (s) => `Final Score: ${s} points`,
    'solo.highscore': (s) => `Personal Best: ${s} points`,
    'solo.newrecord': '🏅 New Personal Best!',
